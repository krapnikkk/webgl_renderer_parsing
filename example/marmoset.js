marmoset = {}; (function (marmoset) {
    ...
    function AnimatedObject(a, c, b) {
        ...
        if (a = a.get(c.file)) this.keyFramesByteStream = new ByteStream(a.data),
    ...
    AnimatedObject.prototype.getFreeCachedWorldTransform = function (a) {
        ...
        if (this.cachedFrameUse0 <= this.cachedFrameUse1 && this.cachedFrameUse0 <= this.cachedFrameUse2 && this.cachedFrameUse0 <= this.cachedFrameUse3) return this.cachedFrame0 = a,
            this.cachedFrameUse0 = 0,
            this.cachedWorldTransform0;
        if (this.cachedFrameUse1 <= this.cachedFrameUse0 && this.cachedFrameUse1 <= this.cachedFrameUse2 && this.cachedFrameUse1 <= this.cachedFrameUse3) return this.cachedFrame1 = a,
            this.cachedFrameUse1 = 0,
            this.cachedWorldTransform1;
        if (this.cachedFrameUse2 <= this.cachedFrameUse0 && this.cachedFrameUse2 <= this.cachedFrameUse1 && this.cachedFrameUse2 <= this.cachedFrameUse3) return this.cachedFrame2 = a,
    ...
    AnimatedObject.prototype.unPackKeyFrames = function () {
        if (this.keyFramesByteStream) {
            ...
            for (var a = 0,
                c = c[0], a = 1 + c, c = this.animatedProperties.length, e = 0; e < c; e++) {
    ...
    AnimatedObject.prototype.evaluateLocalTransformAtFramePercent = function (a, c, b, d) {
        if (this.useFixedLocalTransform) Matrix.copy(c, this.animatedLocalTransform.cachedmatrix0);
            ...
            e ? Matrix.copy(c, e) : ((e = this.animatedLocalTransform.getFreeCachedTransform(a)) ? (this.animatedLocalTransform.evaluateMatrix(e, this.totalFrames, a, b), Matrix.copy(c, e)) : this.animatedLocalTransform.evaluateMatrix(c, this.totalFrames, a, b), 0 != this.turnTableSpin && (a = Matrix.rotation(Matrix.empty(), this.turnTableSpin, 1), Matrix.mul(c, c, a)), c[12] -= c[0] * this.pivot.x + c[4] * this.pivot.y + c[8] * this.pivot.z, c[13] -= c[1] * this.pivot.x + c[5] * this.pivot.y + c[9] * this.pivot.z, c[14] -= c[2] * this.pivot.x + c[6] * this.pivot.y + c[10] * this.pivot.z, c[15] -= c[3] * this.pivot.x + c[7] * this.pivot.y + c[11] * this.pivot.z)
        }
    };
    ...
    AnimatedProperty.prototype.evaluateCurve = function (a, c) {
        ...
        3 == this.splineKF1.interpolation && (g = b - (this.splineKF2.frameIndex - this.splineKF1.frameIndex), k = e - this.splineKF1.weighOut);
            ...
            if (a >= b.keyframesSharedBufferUShorts[m + this.frameIndexOffsetUShort] && a <= b.keyframesSharedBufferUShorts[n + this.frameIndexOffsetUShort]) {
                ...
                if (1 == l || 3 == l) {
                    var p = l = !1,
                        ...
                        B = 1,
                        z = 1;
                    0 != this.weighInOffsetFloat && (t = b.keyframesSharedBufferFloats[k + this.weighInOffsetFloat], y = b.keyframesSharedBufferFloats[f + this.weighInOffsetFloat], A = b.keyframesSharedBufferFloats[k + this.weighOutOffsetFloat], B = b.keyframesSharedBufferFloats[f + this.weighOutOffsetFloat]);
                    ...
                    h < g - 1 && (p = !0, q = b.keyframesSharedBufferFloats[d + (h + 1) * this.indexFloatSkip + this.valueOffsetFloat], w = b.keyframesSharedBufferUShorts[e + (h + 1) * this.indexUShortSkip + this.frameIndexOffsetUShort], 0 != this.weighInOffsetFloat && (E = b.keyframesSharedBufferFloats[d + (h + 1) * this.indexFloatSkip + this.weighInOffsetFloat], z = b.keyframesSharedBufferFloats[d + (h + 1) * this.indexFloatSkip + this.weighOutOffsetFloat]));
                    l && p ? (this.splineKF0.value = r, this.splineKF1.value = s, this.splineKF2.value = u, this.splineKF3.value = q, this.splineKF0.frameIndex = x, this.splineKF1.frameIndex = m, this.splineKF2.frameIndex = n, this.splineKF3.frameIndex = w, this.splineKF0.weighIn = v, this.splineKF0.weighOut = F, this.splineKF1.weighIn = t, this.splineKF1.weighOut = A, this.splineKF2.weighIn = y, this.splineKF2.weighOut = B, this.splineKF3.weighIn = E, this.splineKF3.weighOut = z) : (this.splineKF0.value = s, this.splineKF1.value = s, this.splineKF2.value = u, this.splineKF3.value = u, this.splineKF0.frameIndex = m, this.splineKF1.frameIndex = m, this.splineKF2.frameIndex = n, this.splineKF3.frameIndex = n, this.splineKF1.weighIn = t, this.splineKF2.weighIn = y, this.splineKF1.weighOut = A, this.splineKF2.weighOut = B, p ? (this.splineKF3.value = q, this.splineKF3.frameIndex = w, this.splineKF3.weighIn = E, this.splineKF3.weighOut = z) : (this.splineKF3.frameIndex++, this.splineKF3.value = this.splineKF1.value, this.splineKF3.weighIn = 1, this.splineKF3.weighOut = 1), l ? (this.splineKF0.value = r, this.splineKF0.frameIndex = x, this.splineKF0.weighIn = v, this.splineKF0.weighOut = F) : (this.splineKF0.value = this.splineKF2.value, this.splineKF0.weighIn = 1, this.splineKF0.weighOut = 1, 0 < this.splineKF0.frameIndex ? this.splineKF0.frameIndex-- : (this.splineKF1.frameIndex++, this.splineKF2.frameIndex++, this.splineKF3.frameIndex++, a++)));
    ...
    AnimatedTransform.prototype.evaluateMatrix = function (a, c, b, d) {
        if (this.lockTransform) Matrix.copy(a, this.cachedmatrix0);
            ...
            this.hasScale && (c = this.getTRSValue(b, this.SX, 1), f = this.getTRSValue(b, this.SY, 1), e = this.getTRSValue(b, this.SZ, 1), this.matrix[0] *= c, this.matrix[4] *= f, this.matrix[8] *= e, this.matrix[1] *= c, this.matrix[5] *= f, this.matrix[9] *= e, this.matrix[2] *= c, this.matrix[6] *= f, this.matrix[10] *= e, this.matrix[3] *= c, this.matrix[7] *= f, this.matrix[11] *= e);
    ...
    AnimatedTransform.prototype.getFreeCachedTransform = function (a) {
        ...
        this.cachedFrameUse2--;
        this.cachedFrameUse3--;
        if (this.cachedFrameUse0 <= this.cachedFrameUse1 && this.cachedFrameUse0 <= this.cachedFrameUse2 && this.cachedFrameUse0 <= this.cachedFrameUse3 || this.cachedFrame0 == a) return this.cachedFrame0 = a,
            this.cachedFrameUse0 = 0,
            this.cachedmatrix0;
        if (this.cachedFrameUse1 <= this.cachedFrameUse0 && this.cachedFrameUse1 <= this.cachedFrameUse2 && this.cachedFrameUse1 <= this.cachedFrameUse3 || this.cachedFrame1 == a) return this.cachedFrame1 = a,
            this.cachedFrameUse1 = 0,
            this.cachedmatrix1;
        if (this.cachedFrameUse2 <= this.cachedFrameUse0 && this.cachedFrameUse2 <= this.cachedFrameUse1 && this.cachedFrameUse2 <= this.cachedFrameUse3 || this.cachedFrame2 == a) return this.cachedFrame2 = a,
            this.cachedFrameUse2 = 0,
            this.cachedmatrix2;
        this.cachedFrame3 = a;
        this.cachedFrameUse3 = 0;
    ...
    function Animation(a, c) {
        ...
        this.debugString = "";
        if (c.animatedObjects) for (var b = c.animatedObjects.length,
            d = 0; d < b; ++d) {
    ...
    Animation.prototype.lerpModelPartTransform = function (a, c, b, d) {
        ...
        if (e.useFixedWorldTransform) Matrix.copy(b, e.cachedWorldTransform0);
            ...
            k || ((k = e.getFreeCachedWorldTransform(h)) || (k = Matrix.identity()), this.evaluateModelPartTransformAtFrame(a, h, k, d));
            a = 1 - f;
    ...
    Animation.prototype.isVisibleAtFramePercent = function (a, c) {
        for (var b = a,
            ...
            if (d.visibleProperty) {
                ...
                if ("" != d.debugString || "" != d.visibleProperty.debugString) return this.debugString += d.debugString,
    ...
    Animation.prototype.getWorldTransform = function (a, c, b, d, e) {
        ...
        if (a.useFixedWorldTransform) Matrix.copy(b, a.cachedWorldTransform0);
            ...
            Matrix.copy(b, g);
            if (a.parentIndex != a.id) for (var k = a.parentIndex,
                n = 0; 100 > n; n++) a = this.animatedObjects[k],
                    f = this.getObjectAnimationFramePercent(a, c),
                    g = Matrix.identity(),
                    a.evaluateLocalTransformAtFramePercent(f, g, !0, e),
                    (f = a.modelPartIndex != a.id) ? (f = Matrix.identity(), this.getAnimatedLocalTransform(a.id, c, f), h = Matrix.identity(), Matrix.mul(h, g, b), Matrix.mul(b, f, h)) : (h = Matrix.identity(), Matrix.copy(h, b), Matrix.mul(b, g, h)),
    ...
    Archive.prototype.checkSignature = function (a) {
        ...
        if (!c) return !1;
        for (var b = 5381,
            d = 0; d < a.data.length; ++d) b = 33 * b + a.data[d] & 4294967295;
        a = new BigInt;
    ...
    BigInt.prototype.setBytes = function (a, c) {
        ...
        if (c) for (var d = 0,
            b = a.length - 1; 0 <= b; b -= 2) this.digits[d++] = a[b] + (0 < b ? 256 * a[b - 1] : 0);
        else for (d = 0; d < b; ++d) this.digits[d] = a[2 * d] + 256 * a[2 * d + 1];
        this.trim()
    };
    ...
    BigInt.prototype.lessThan = function (a) {
        if (this.digits.length == a.digits.length) for (var c = this.digits.length - 1; 0 <= c; --c) {
            var b = this.digits[c],
                d = a.digits[c];
            if (b != d) return b < d
        }
    ...
    BigInt.prototype.shiftLeft = function (a) {
        if (0 < a) {
            ...
            a %= 16;
            for (var b = 16 - a,
                d = this.digits.length + c + 1,
                e = new BigInt(d), f = 0; f < d; ++f) e.digits[f] = ((f < c || f >= this.digits.length + c ? 0 : this.digits[f - c]) << a | (f < c + 1 ? 0 : this.digits[f - c - 1]) >>> b) & 65535;
            e.trim();
            return e
        }
    ...
    BigInt.prototype.bitCount = function () {
        var a = 0;
        if (0 < this.digits.length) for (var a = 16 * (this.digits.length - 1), c = this.digits[this.digits.length - 1]; c;) c >>>= 1,
            ++a;
        return a
    };
    ...
    BigInt.prototype.mul = function (a) {
        for (var c = new BigInt(this.digits.length + a.digits.length), b = c.digits, d = 0; d < this.digits.length; ++d) for (var e = this.digits[d], f = 0; f < a.digits.length; ++f) for (var g = e * a.digits[f], h = d + f; g;) {
            var k = (g & 65535) + b[h];
            b[h] = k & 65535;
            g >>>= 16;
            g += k >>> 16; ++h
    ...
    BigInt.prototype.mod = function (a) {
        ...
        if (!this.lessThan(a)) {
            for (var b = new BigInt(a.digits), b = b.shiftLeft(c.bitCount() - b.bitCount()); !c.lessThan(a);) b.lessThan(c) && c.sub(b),
                b.shiftRight();
            c.trim()
        }
        return c
    ...
    BigInt.prototype.powmod = function (a, c) {
        for (var b = new BigInt([1]), d = this.mod(c); a;) a & 1 && (b = b.mul(d).mod(c)),
            a >>>= 1,
            d = d.mul(d).mod(c);
        return b
    };
    ...
    function Bounds(a) {
        for (var c = 0; c < a.length; ++c) {
            var b = a[c].bounds;
            if (void 0 === this.min) this.min = [b.min[0], b.min[1], b.min[2]],
                this.max = [b.max[0], b.max[1], b.max[2]];
            else for (var d = 0; 3 > d; ++d) this.min[d] = Math.min(b.min[d], this.min[d]),
    ...
    ByteStream.prototype.readCString = function () {
        for (var a = this.bytes,
            c = a.length,
            b = 0; b < c; ++b) if (0 == a[b]) return a = String.fromCharCode.apply(null, this.bytes.subarray(0, b)),
    ...
    ByteStream.prototype.asString = function () {
        for (var a = "",
            c = 0; c < this.bytes.length; ++c) a += String.fromCharCode(this.bytes[c]);
        return a
    };
    ...
    ControlRect.prototype.hasChildControlRect = function (a) {
        for (var c = 0; c < this.childControlRects.length; c++) if (this.childControlRects[c] == a) return !0;
        return !1
    };
    ...
    var prepareEmbedParams = function (a) {
        a = a || {};
        if (document.location.search) for (var c = document.location.search.substring(1).split("&"), b = 0; b < c.length; ++b) {
            var d = c[b].split("=");
            a[d[0]] = d[1]
        }
        c = function (a) {
        ...
        embed = function (a, c) {
            ...
            } else b = new WebViewer(c.fullFrame ? window.innerWidth : c.width, c.fullFrame ? window.innerHeight : c.height, a, !!d),
                document.body.appendChild(b.domRoot),
                c.fullFrame && (b.domRoot.style.position = "absolute", b.domRoot.style.left = b.domRoot.style.top = 0, window.addEventListener("resize",
                    function () {
        ...
        fetchThumbnail = function (a, c, b, d) {
            var e = !1,
                ...
                g = function (a) {
                    (a = (new Archive(a)).extract("thumbnail.jpg")) ? TextureCache.parseFile(a, c, d) : e ? b && b() : (e = !0, Network.fetchBinaryIncremental(f, g, b, 394240));
                    return 0
                };
    ...
    Fog.prototype.draw = function (a, c) {
        ...
        for (var g = 0; g < a.lights.count + 1; ++g) {
            ...
            if (0 == g) {
                ...
                k && (k = Matrix.mul(Matrix.empty(), a.lights.finalTransformBuffer.subarray(16 * h), a.lights.matrix), b.uniformMatrix4fv(m.uShadowProj, !1, k), a.shadow.depthTextures[h].bind(n.samplers.uShadowMap), h = 0, 1 < a.postRender.sampleCount && (h = a.postRender.currentSample() / a.postRender.sampleCount), b.uniform1f(m.uDitherOffset, h), b.uniform3fv(m.uAABBMin, a.bounds.min), b.uniform3fv(m.uAABBMax, a.bounds.max), h = Vect.lerp(Vect.empty(), a.bounds.min, a.bounds.max, 0.5), k = Vect.distance(h, a.bounds.min), b.uniform4f(m.uCylinder, h[0], h[1], h[2], k * k))
            }
    ...
    Input.prototype.attach = function (a) {
        ...
        a = function (a) {
            for (var d = !1,
                e = this.element.getBoundingClientRect(), f = 0; 3 > f; ++f) {
                ...
                if (g.pressed) {
                    ...
                    g.position[0] = d;
                    g.position[1] = h;
                    if (2 == f && a.altKey) for (g = 0; g < this.onZoom.length; ++g) this.onZoom[g](2 * n);
                    else if (1 <= f || a.ctrlKey) for (g = 0; g < this.onPan.length; ++g) this.onPan[g](k, n);
                    else if (0 == f) if (a.shiftKey) for (g = 0; g < this.onPan2.length; ++g) this.onPan2[g](k, n);
                    else for (g = 0; g < this.onDrag.length; ++g) this.onDrag[g](d, h, k, n);
                    d = !0
                }
            }
            d && c(a)
        ...
        a = function (a) {
            for (var d = !1,
                e = 0; e < a.changedTouches.length; ++e) {
                    ...
                    if (this.tapPossible) {
                        ...
                        if (24 > Math.max(Math.abs(d - g.startX), Math.abs(h - g.startY))) {
                            ...
                            if (void 0 !== this.doubleTapTimer) {
                                ...
                                if (k && n) for (g = !0, e = 0; e < this.onDoubleTap.length; ++e) this.onDoubleTap[e](d, h)
                            }
        ...
        a = function (a) {
            ...
            if (1 == d.length && 1 >= this.touchCountFloor) {
                ...
                if (n = d[0], e = this.touches[n.identifier], g = d[1], h = this.touches[g.identifier], e && h) {
                    ...
                    h.x = m;
                    h.y = l;
                    if (0 < s) for (h = s / (s + u), e = 0; e < this.onZoom.length; ++e) this.onZoom[e](2 * (p - r) * h);
                    if (0 < u) for (h = u / (s + u), e = 0; e < this.onDrag.length; ++e) this.onPan[e](f * h, g * h)
                }
            } else if (3 <= d.length) {
                for (e = r = p = m = n = 0; e < d.length; ++e) g = d[e],
                    h = this.touches[g.identifier],
                    k = g.clientX - f.left,
                    g = g.clientY - f.top,
                    p += k,
                    r += g,
                    h && (n += h.x, m += h.y, h.x = k, h.y = g);
                n /= d.length;
                m /= d.length;
                p /= d.length;
                r /= d.length;
    ...
    function Lights(a, c) {
        ...
        for (d = 0; d < this.count; ++d) {
            ...
            1 == this.matrixWeights[d] ? (Matrix.mul4(b, this.matrix, b[0], b[1], b[2], b[3]), Matrix.mulVec(e, this.matrix, e[0], e[1], e[2])) : 2 == this.matrixWeights[d] && (Matrix.mul4(b, c.viewMatrix, b[0], b[1], b[2], b[3]), Matrix.mulVec(e, c.viewMatrix, e[0], e[1], e[2]))
        }
    }
    ...
    Lights.prototype.update = function (a, c) {
        ...
        for (var f = new Float32Array(this.finalTransformBuffer), g = Matrix.empty(), h = Matrix.empty(), k = Matrix.empty(), n = Vect.empty(), m = Vect.empty(), l = Vect.empty(), p = Vect.empty(), e = Vect.empty(), r = [], s = [], u = Matrix.create(0.5, 0, 0, 0.5, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0.5, 0, 0, 0, 1), d = 0; d < this.count; ++d) {
            ...
            for (n = 0; 8 > n; ++n) e[0] = n & 1 ? c.max[0] : c.min[0],
        ...
        e = !1;
        for (d = 0; d < b.length; ++d) if (b[d] != this.matrix[d]) {
            e = !0;
            break
        }
        for (d = 0; d < this.shadowCount; d++) if (e && 1 == this.matrixWeights[d]) this.shadowsNeedUpdate[d] = 1;
        else for (b = 16 * d; b < 16 * d + 16; ++b) if (f[b] != this.finalTransformBuffer[b]) {
    ...
    ListBox.prototype.spawnControl = function (a, c, b, d, e, f) {
        ...
        for (b = 1; b < e; b++) a = this.labelPixelInset + this.textOffsetsX[b - 1],
    ...
    ListBox.prototype.showList = function (a) {
        for (var c = this.listBoxButtons.length,
            b = 0; b < c; b++) this.listBoxButtons[b].setVisible(a);
        this.closed = !a;
    ...
    ListBox.prototype.setupCallbacks = function () {
        var a = function (a) {
            ...
            } else b = this.openBackground.controlRect.linkedControl,
                b = b.getBoundingClientRect(),
                c = a.clientX - b.left,
                a = a.clientY - b.top,
                c /= b.width,
        ...
        for (var c = function (a) {
            ...
            for (var b = 0; b < a; b++) this.listBoxButtons[b].controlRect.mouseOver && (this.selectItem(b), b = a, this.selectionChangedCallback && this.selectionChangedCallback(this));
            this.showList(!1)
        }.bind(this), d = this.listBoxButtons.length, e = 0; e < d; e++) this.listBoxButtons[e].controlRect.callBack = c,
    ...
    function Material(a, c, b) {
        ...
        if (b.extrasTexCoordRanges) for (var f in b.extrasTexCoordRanges) this.extrasTexCoordRanges[f] = new Float32Array(b.extrasTexCoordRanges[f].scaleBias);
        ...
        this.extrasTexCoordRanges.emissiveTex && (d.push("#define EMISSIVE"), b.emissiveSecondaryUV && (d.push("#define EMISSIVE_SECONDARY_UV"), e = !0));
    ...
    Material.prototype.bind = function (a, c) {
        ...
        this.usesRefraction && (a.refractionSurface && a.refractionSurface.bind(s.tRefraction), d = Matrix.mul(Matrix.empty(), x, d.invMatrix), l.uniformMatrix4fv(p.uRefractionViewProjection, !1, d), this.refractionParams.newRefraction ? (d = 0.8 * c.mesh.bounds.averageExtent, f = this.refractionParams.IOR - 1, l.uniform1f(p.uRefractionRayDistance, d * (0 < f ? f : 0))) : l.uniform1f(p.uRefractionRayDistance, this.refractionParams.distantBackground ? 1E10 : 4 * c.mesh.bounds.maxExtent), l.uniform3fv(p.uRefractionTint, this.refractionParams.tint), l.uniform1f(p.uRefractionAlbedoTint, this.refractionParams.useAlbedoTint ? 1 : 0), l.uniform1f(p.uRefractionIOREntry, 1 / this.refractionParams.IOR), (m = this.extrasTexCoordRanges.refractionMaskTex) && l.uniform4fv(p.uTexRangeRefraction, m));
        if (m = this.extrasTexCoordRanges.emissiveTex) l.uniform4fv(p.uTexRangeEmissive, m),
            l.uniform1f(p.uEmissiveScale, this.emissiveIntensity); (m = this.extrasTexCoordRanges.aoTex) && l.uniform4fv(p.uTexRangeAO, m);
        ...
        g === this.stripShader && (l.uniform1fv(p.uStrips, a.stripData.strips), l.uniform2f(p.uStripRes, 2 / b.size[0], 2 / b.size[1]));
    ...
    function PlaybackControls(a) {
        ...
        if (0 != g) {
            ...
            l > a.width && (this.idealSliderWidth = a.width - (118 + (this.totalListBoxPixelsX + 14)) - this.centerOffset, a = 0, this.cameraList && a++, this.animationList && a++, 1 == a && (this.idealSliderWidth += 56, this.centerOffset -= 14), 2 == a && (this.idealSliderWidth += 63, this.centerOffset -= 63));
            this.setupCallbacks()
        }
    }
    PlaybackControls.prototype.resize = function (a) {
        ...
        var f = 116,
            g = f + e + 14;
        this.compactMode && (f = 58, e += 44 + d, 0 < d && (c += 32), !d && (b += 32));
        var d = 32 / e,
            h = d + 14 / e,
            k = 1 - h,
    ...
    function PostRender(a, c, b) {
        ...
        this.desc = c;
        c = [];
        0 != this.desc.sharpen && c.push("#define SHARPEN"); (this.useBloom = 0 < this.desc.bloomColor[0] * this.desc.bloomColor[3] || 0 < this.desc.bloomColor[1] * this.desc.bloomColor[3] || 0 < this.desc.bloomColor[2] * this.desc.bloomColor[3]) && c.push("#define BLOOM");
        ...
        this.sampleIndex = 0;
        this.sampleCount = 1;
        b && (this.sampleCount = 4, this.sampleOffsets = [[- 0.5, -0.5], [0.5, -0.5], [- 0.5, 0.5], [0.5, 0.5]]);
    ...
    PostRender.prototype.prepareBloom = function (a) {
        if (this.useBloom && this.bloomShader.complete() && this.shrinkShader.complete()) {
            ...
            for (d = 0; d < this.bloomSamples; ++d) b = c[4 * d + 0],
    ...
    Scene.prototype.draw = function (a) {
        ...
        if (this.sceneLoaded) {
            ...
            c.depthFunc(c.LESS);
            for (var d = !1,
                b = 0; b < this.meshRenderables.length; ++b) if (this.meshRenderables[b].material.usesRefraction) {
                    d = !0;
                    break
                }
            if (d) for (this.refractionSurface && this.refractionSurface.desc.width == a.color0.desc.width && this.refractionSurface.desc.height == a.color0.desc.height || (this.refractionSurface = new Texture(c, a.color0.desc), this.refractionSurface.loadArray(null, a.color0.format, a.color0.componentType), this.refractionBuffer = new Framebuffer(this.gl, {
                color0: this.refractionSurface
            })), this.refractionBuffer.bind(), this.postRender.blitTexture(a.color0), a.bind(), b = 0; b < this.meshRenderables.length; ++b) this.meshRenderables[b].material.usesRefraction && this.meshRenderables[b].visible && this.meshRenderables[b].draw(this);
    ...
    function SceneAnimator(a, c, b) {
        ...
        if (this.loadAnimations) {
            if (b.meshIDs) for (var d = b.meshIDs.length,
                e = 0; e < d; ++e) {
                var f = b.meshIDs[e].partIndex;
                this.meshIDs.push(f)
            }
            if (b.lightIDs) for (d = b.lightIDs.length, e = 0; e < d; ++e) f = b.lightIDs[e],
                f = f.partIndex,
                this.lightIDs.push(f);
            if (b.materialIDs) for (d = b.materialIDs.length, e = 0; e < d; ++e) f = b.materialIDs[e],
                f = f.partIndex,
            ...
            if (b.skinningRigs && this.loadSkinningRigs) for (d = b.skinningRigs.length, e = 0; e < d; ++e) {
                var g = new SkinningRig(c, b.skinningRigs[e], f);
                "" == g.debugString ? this.skinningRigs.push(g) : (this.debugString += "<br>Error loading skinning rig " + e + " :" + g.debugString, this.debugString += "<br>Skipping the rest", e = d)
            }
            if (b.animations) for (f = b.animations.length, e = 0; e < f; ++e) d = new Animation(c, b.animations[e]),
                this.animations.push(d);
            this.startMS = Date.now();
            f = this.animations.length;
            if (this.linkSceneObjects && 0 != f) {
                for (e = 0; e < f; e++) for (c = this.animations[e], d = c.animatedObjects.length, b = 0; b < d; b++) g = c.animatedObjects[b],
                    "LightSO" == g.sceneObjectType && (g.lightIndex = this.findLightIndexByPartIndex(b), -1 != g.lightIndex ? c.lightObjects.push(g) : this.debugString += "<br> got light not in scene " + g.name),
                    "FogSO" == g.sceneObjectType && (this.fogObjectIndex = b),
                    "SubMeshSO" == g.sceneObjectType && 0 == e && (this.subMeshObjectIndices.push(b), this.subMeshLiveIndices.push(- 1)),
                    "Material" == g.sceneObjectType && (g.materialIndex = this.findMaterialIndexByPartIndex(b), -1 == g.materialIndex ? this.debugString += "<br> can't find material index for object " + b : c.materialObjects.push(g)),
                    "TurnTableSO" == g.sceneObjectType && c.turnTableObjects.push(g),
                    "MeshSO" == g.sceneObjectType && (g.meshIndex = this.findMeshIndexByPartIndex(this.scene.meshes, b), -1 == g.meshIndex ? (this.debugString += "<br> can't find mesh index for object " + b, this.logObjectInfo(b, 0)) : (c.meshObjects.push(g), g.mesh = this.scene.meshes[g.meshIndex], -1 != g.skinningRigIndex && g.mesh && g.skinningRigIndex < this.skinningRigs.length && (g.skinningRig = this.skinningRigs[g.skinningRigIndex], g.skinningRig.isRigidSkin || (g.mesh.dynamicVertexData ? g.skinningRig.useOriginalMeshVertices(g.mesh) : (this.debugString += "Skinning object - but mesh is not dynamic", this.debugString += "<br>Rig index " + g.skinningRigIndex, this.debugString += " not tagged as rigid"))))),
                    "CameraSO" == g.sceneObjectType && c.cameraObjects.push(g);
                c = this.animations[0];
                b = c.cameraObjects.length;
                for (e = 0; e < b; e++) if (f = c.cameraObjects[e], d = this.scene.cameras[f.name]) {
                    if (d = d.view) d = new View(d),
                        this.cameraObjectIndices.push(f.id),
                        this.views.push(d),
                        this.viewYawOffsets.push(0),
                        this.viewPitchOffsets.push(0)
                } else this.debugString += "<br>no camDesc for " + f.name,
                    this.views.push(a.view);
                a = this.scene.meshes.length;
                f = this.subMeshObjectIndices.length;
                for (e = d = 0; e < a; e++) for (g = this.scene.meshes[e], b = 0; b < f; b++) {
                    ...
                    if (n.mesh == g) {
                        for (h = 0; h < g.numSubMeshes; h++) this.subMeshLiveIndices[b + (g.numSubMeshes - 1 - h)] = d,
                            d++;
                        b = f
                    }
                }
                for (e = 0; e < f; e++) - 1 == this.subMeshLiveIndices[e] && (this.debugString += "<br>Missing mesh? Unused submesh " + e + " of " + f);
    ...
    SceneAnimator.prototype.flagAllForDebugging = function () {
        for (var a = this.animations.length,
            c = 0; c < a; c++) for (var b = this.animations[c], d = b.animatedObjects.length, e = 0; e < d; e++) b.animatedObjects[e].debugMe = !0
    };
    SceneAnimator.prototype.checkDebug = function () {
        ...
        for (var b = 0; b < c; b++) {
            var d = a.animatedObjects[b];
            if ("" != d.debugString || "" != d.animatedLocalTransform.debugString) this.debugString += "<br>--------------------------------------------------Got object bug info:",
            ...
            d.skinningRig && "" != d.skinningRig.debugString && (this.debugString += "<br>--------------------------------------------------Got skin rig info:", this.debugString += d.skinningRig.debugString, d.skinningRig.debugString = "", this.showDebugInfo = this.stopEverything = !0)
        }
    ...
    SceneAnimator.prototype.selectDefaultCamera = function () {
        if (- 1 != this.defaultCameraGlobalIndex && 0 < this.animations.length) for (var a = this.animations[0], c = a.cameraObjects.length, b = 0; b < c; b++) if (a.cameraObjects[b].id == this.defaultCameraGlobalIndex) {
    ...
    SceneAnimator.prototype.updateAnimationPlayback = function () {
        if (!this.stopEverything || !this.runDebugMode) {
            ...
            if (this.paused || !this.playAnimations) this.startMS = 0 < this.playbackSpeed ? Date.now() - 1E3 * this.totalSeconds / (this.playbackSpeed * this.scenePlaybackSpeed) : Date.now() - 1E3 * this.totalSeconds,
    ...
    SceneAnimator.prototype.findFixedTransforms = function () {
        for (var a = this.animations.length,
            c = 0; c < a; c++) for (var b = this.animations[c], d = b.animatedObjects.length, e = 0; e < d; e++) {
                var f = b.animatedObjects[e];
                if (!f.useFixedWorldTransform && !b.hasAnimationInHierarchy(f)) if ("Material" == f.sceneObjectType) f.setFixedWorldTransform(Matrix.identity()),
                    f.setFixedLocalTransform(Matrix.identity());
                else {
                    var g = Matrix.identity(),
                        h = Matrix.identity();
                    b.hasParentTypeInHierarchy(f, "SceneRootSO") ? (b.getWorldTransform(f.id, 0, g, this.sceneScale, !1), f.evaluateLocalTransformAtFramePercent(0, h, !0, !1)) : (b.evaluateModelPartTransformAtFrame(f.id, 0, g, !1), f.evaluateLocalTransformAtFramePercent(0, h, !1, !1));
    ...
    SceneAnimator.prototype.refreshTransformsOnly = function () {
        ...
        if (this.animateLights) for (c = a.lightObjects.length, b = 0; b < c; b++) d = a.lightObjects[b],
            d.useFixedWorldTransform || (m = this.scene.lights.getLightPos(d.lightIndex), l = this.scene.lights.getLightDir(d.lightIndex), p = Matrix.identity(), a.getWorldTransform(d.id, this.totalSeconds, p, this.sceneScale, !0), l[0] = p[8], l[1] = p[9], l[2] = p[10], 0 != m[3] ? (m[0] = p[12], m[1] = p[13], m[2] = p[14], this.scene.lights.setLightPos(d.lightIndex, m)) : this.scene.lights.setLightPos(d.lightIndex, l), this.scene.lights.setLightDir(d.lightIndex, l))
    };
    SceneAnimator.prototype.findMeshIndexByPartIndex = function (a, c) {
        for (var b = 0; b < this.meshIDs.length; ++b) if (c == this.meshIDs[b]) return b;
        return - 1
    };
    SceneAnimator.prototype.findLightIndexByPartIndex = function (a) {
        for (var c = 0; c < this.lightIDs.length; c++) if (a == this.lightIDs[c]) return c;
        return - 1
    };
    SceneAnimator.prototype.findMaterialIndexByPartIndex = function (a) {
        for (var c = 0; c < this.materialIDs.length; c++) if (a == this.materialIDs[c]) return c;
        return - 1
    };
    ...
    SceneAnimator.prototype.poseMeshes = function () {
        for (var a = this.animations[this.selectedAnimationIndex], c = a.meshObjects.length, b = 0; b < c; b++) {
            var d = a.meshObjects[b];
            if (this.enableSkinning && d.skinningRig) if (d.skinningRig.isRigidSkin) a.getWorldTransform(d.id, this.totalSeconds, d.mesh.displayMatrix, this.sceneScale, !0);
            else {
    ...
    SceneAnimator.prototype.updateLights = function () {
        for (var a = this.animations[this.selectedAnimationIndex], c = this.totalSeconds * a.originalFPS, b = a.lightObjects.length, d = 0; d < b; d++) {
            ...
            e.redProperty && (e.redProperty.evaluate(c, h[0], e), h[0] = e.redProperty.lastValue);
    ...
    Shader.prototype.build = function (a, c) {
        ...
        for (d = 0; d < e; ++d) f = b.getActiveAttrib(this.program, d),
    ...
    ShaderCache.prototype.fromURLs = function (a, c, b) {
        var d = "";
        if (b) for (var e = 0; e < b.length; ++e) d = b[e] + "\n" + d;
        b = d + ":" + a + "|" + c;
        e = this.cache[b];
    ...
    ShaderCache.prototype.fetch = function (a, c) {
        "undefined" != typeof ShaderTable ? void 0 !== ShaderTable[a] ? this.resolveIncludes(new String(ShaderTable[a]), c) : c("") : Network.fetchText("src/shader/" + a,
            function (a) {
    ...
    ShaderCache.prototype.resolveIncludes = function (a, c) {
        ...
        if (0 < b.length) for (var f = b.length,
            e = 0; e < b.length; ++e) this.fetch(b[e].path,
                function (d) {
                    this.src = d;
                    if (0 >= --f) {
    ...
    function ShadowCollector(a, c) {
        ...
        if (0 < this.shadowCount) {
            ...
            for (var g = 0; g < this.shadowCount; ++g) this.depthTextures[g] = new Texture(a, b),
    ...
    ShadowCollector.prototype.collect = function (a, c) {
        for (var b = this.gl,
            ...
            h = d.matrix,
            k = 0 != a.sceneAnimator,
            n = Matrix.empty(), m = !1, l = 0; l < e; ++l) if (d.shadowsNeedUpdate[l]) {
                ...
                for (var r = 0; r < a.meshRenderables.length; ++r) {
                    var s = a.meshRenderables[r],
                        u = s.material; !s.mesh.desc.castShadows || !u.castShadows || 0 < u.shadowAlphaTest || (k && b.uniformMatrix4fv(p.params.uMeshTransform, !1, s.mesh.displayMatrix), s.drawShadow(p.attribs.vPosition))
                }
                p = this.shaderAlphaTest;
                p.bind();
                b.uniformMatrix4fv(p.params.uViewProjection, !1, n);
                b.uniformMatrix4fv(p.params.uMeshTransform, !1, Matrix.identity());
                for (r = 0; r < a.meshRenderables.length; ++r) s = a.meshRenderables[r],
                    u = s.material,
                    s.mesh.desc.castShadows && u.castShadows && 0 < u.shadowAlphaTest && (u.textures.albedo.bind(p.samplers.tAlbedo), k && (b.uniform2f(p.params.uUVOffset, u.uOffset, u.vOffset), b.uniformMatrix4fv(p.params.uMeshTransform, !1, s.mesh.displayMatrix)), s.drawAlphaShadow(p.attribs.vPosition, p.attribs.vTexCoord))
            }
    ...
    function SkinningRig(a, c, b) {
        ...
        if (a = a.get(this.srcVFile)) if (a.data) {
    ...
    SkinningRig.prototype.copyOriginalVertices = function (a) {
        if (!this.unTransformedVertices) if (this.unTransformedVertices = new Float32Array(3 * a.vertexCount), this.unTransformedNormals = new Float32Array(3 * a.vertexCount), this.unTransformedTangents = new Float32Array(3 * a.vertexCount), this.unTransformedBiTangents = new Float32Array(3 * a.vertexCount), this.skinVertexWeights = new Float32Array(a.vertexCount), this.skinVertexTransform4x3 = new Float32Array(12), a.dynamicVertexData) {
            ...
            for (g = 0; g < a.vertexCount; g++) f = (a.stride * g + d) / 4,
    ...
    SkinningRig.prototype.deformMeshVertices = function (a, c) {
        if (0 != this.skinningClusters.length && this.unTransformedVertices) {
            ...
            var g = f,
                h = f += 4;
            f += 4;
            for (var k = this.unTransformedVertices.length / 3,
                n = 0,
                m = 0; m < k; ++m) {
                var l = m,
                    p = (l * a.stride + g) / 2,
                ...
                } else for (var t = this.skinVertexWeights[l] = 0; t < u; t++) x = this.linkMapWeights[n + t],
                    w = this.linkMapClusterIndices[n + t],
                    w < this.skinningClusters.length && (w = this.skinningClusters[w], v = w.matrix, q[0] += x * v[0], q[1] += x * v[1], q[2] += x * v[2], q[3] += x * v[4], q[4] += x * v[5], q[5] += x * v[6], q[6] += x * v[8], q[7] += x * v[9], q[8] += x * v[10], q[9] += x * v[12], q[10] += x * v[13], q[11] += x * v[14], this.skinVertexWeights[l] += x, 1 == w.linkMode && (this.skinVertexWeights[l] = 1));
                ...
                if (0 < this.skinVertexWeights[l]) {
                    ...
                    e[r] = Math.floor(q);
                    e[r + 1] = Math.floor(x)
                } else y = this.unTransformedVertices[3 * m + 0],
                    E = this.unTransformedVertices[3 * m + 1],
                    F = this.unTransformedVertices[3 * m + 2],
                    d[b * m] = y * c,
                    d[b * m + 1] = E * c,
    ...
    function Sky(a, c, b) {
        ...
        if (void 0 !== d) {
            ...
            c = d.data;
            for (var d = d.data.length,
                e = d / 4,
                f = new Uint8Array(d), g = 0, h = 0; g < d; ++h) f[g++] = c[h + 2 * e],
                    f[g++] = c[h + e],
                    f[g++] = c[h],
                    f[g++] = c[h + 3 * e];
        ...
        if (1 <= this.backgroundMode) if (this.backgroundShader = a.shaderCache.fromURLs("skyvert.glsl", 3 == this.backgroundMode ? "skySH.glsl" : "sky.glsl", ["#define SKYMODE " + this.backgroundMode]), this.vertexBuffer = a.createBuffer(), a.bindBuffer(a.ARRAY_BUFFER, this.vertexBuffer), b = 1 / 256, c = 0.5 / 256, d = 2.8 * c, e = 0.5 * c, b = new Float32Array([0, 1, 0, 0.49609375 + b, 0.49609375 + b, 1, 0, 0, 0.9921875 + b, 0.49609375 + b, 0, 0, 1, 0.49609375 + b, 0.9921875 + b, -1, 0, 0, 0 + b, 0.49609375 + b, 0, 0, -1, 0.49609375 + b, 0 + b, 0, -1, 0, 0.9921875 + b, 0 + b, 0, -1, 0, 0.9921875 + b, 0.9921875 + b, 0, -1, 0, 0 + b, 0.9921875 + b, 0, -1, 0, 0 + b, 0 + b, d, 1 - d, -d, 0.5 + c, 0.5 - c, d, 1 - d, d, 0.5 + c, 0.5 + c, -d, 1 - d, d, 0.5 - c, 0.5 + c, -d, 1 - d, -d, 0.5 - c, 0.5 - c, -d, 0, -1 + d, 0.5 - c, 0 + b + c, d, 0, -1 + d, 0.5 + c, 0 + b + c, 1 - d, 0, -d, 0.9921875 + b - c, 0.5 - c, 1 - d, 0, d, 0.9921875 + b - c, 0.5 + c, d, 0, 1 - d, 0.5 + c, 0.9921875 + b - c, -d, 0, 1 - d, 0.5 - c, 0.9921875 + b - c, -1 + d, 0, d, 0 + b + c, 0.5 + c, -1 + d, 0, -d, 0 + b + c, 0.5 - c, 1, 0, 0, 0.9921875 + b - e, 0.49609375 + b, 0, 0, 1, 0.49609375 + b, 0.9921875 + b - e, -1, 0, 0, 0 + b + e, 0.49609375 + b, 0, 0, -1, 0.49609375 + b, 0 + b + e, 0, 1, 0, 0.49609375 + b - e, 0.49609375 + b, 0, 1, 0, 0.49609375 + b, 0.49609375 + b - e, 0, 1, 0, 0.49609375 + b + e, 0.49609375 + b, 0, 1, 0, 0.49609375 + b, 0.49609375 + b + e]), a.bufferData(a.ARRAY_BUFFER, b, a.STATIC_DRAW), a.bindBuffer(a.ARRAY_BUFFER, null), this.indexBuffer = a.createBuffer(), a.bindBuffer(a.ELEMENT_ARRAY_BUFFER, this.indexBuffer), b = new Uint16Array([2, 1, 6, 3, 2, 7, 8, 4, 3, 4, 5, 1, 9, 14, 15, 17, 10, 16, 18, 19, 11, 20, 13, 12, 28, 12, 13, 13, 24, 28, 28, 24, 9, 9, 24, 14, 25, 9, 15, 25, 15, 21, 10, 25, 21, 10, 21, 16, 22, 26, 10, 22, 10, 17, 18, 11, 26, 22, 18, 26, 19, 23, 27, 19, 27, 11, 23, 20, 27, 27, 20, 12]), this.skyIndexCount = b.length, a.bufferData(a.ELEMENT_ARRAY_BUFFER, b, a.STATIC_DRAW), a.bindBuffer(a.ELEMENT_ARRAY_BUFFER, null), 3 == this.backgroundMode) for (this.backgroundCoefficients = new Float32Array(this.diffuseCoefficients), g = 0; g < this.backgroundCoefficients.length; ++g) this.backgroundCoefficients[g] *= this.backgroundBrightness;
        else {
            ...
            }), b = k.valid); !b && a.ext.textureFloat && a.ext.textureFloatLinear && !a.hints.mobile && (this.backgroundTexture.loadArray(null, a.RGB, a.FLOAT), k = new Framebuffer(a, {
                color0: this.backgroundTexture
            }), b = k.valid);
    ...
    StripData.prototype.selectStrip = function (a, c) {
        if (this.selectedStrip == this.STRIP_MENU) {
            ...
            this.selectedStrip = this.STRIP_NONE;
            for (var d = 0; d < this.stripCount; ++d) if (b < this.strips[d]) {
    ...
    Texture.prototype.setParams = function () {
        ...
        if (this.desc.clamp || this.desc.mirror) c = this.desc.clamp ? a.CLAMP_TO_EDGE : a.MIRRORED_REPEAT,
                ...
                if (k && n) {
                    ...
                    if (a <= f.limits.viewportSizes[0] && b <= f.limits.viewportSizes[1]) {
                        ...
                        k.width == a && k.height == b ? (h.loadImage(k, f.RGBA), a = new Framebuffer(f, {
                            color0: h,
                            ignoreStatus: !0
                        }), TextureCache.closeImage(k)) : (b = new Texture(f, c), b.loadImage(k, f.RGB), TextureCache.closeImage(k), h.loadArray(null), a = new Framebuffer(f, {
                            color0: h,
                            ignoreStatus: !0
    ...
    TextureCache.closeImage = function (a) {
        a && 256 < a.width * a.height && (a.onload = null, a.onerror = null, a.src = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D")
    };
    ...
    UI.prototype.showPreview = function (a) {
        ...
        a || fetchThumbnail(this.viewer.sceneURL,
            function (a) {
    ...
    UI.prototype.setThumbnail = function (a) {
        if (this.thumbnail) if (a.height >= this.container.height) {
            ...
            for (var h = 0; 2 > h; ++h) {
                for (var c = f.data,
                    k = a.data,
                    n = 0,
                    m = 0; m < e; ++m) for (var l = 0; l < d; ++l) {
                        for (var p = 0,
                            r = 0,
                            s = 0,
                            u = -2; 2 >= u; ++u) for (var q = m + u,
                                q = 0 > q ? 0 : q >= e ? e - 1 : q, x = -2; 2 >= x; ++x) var w = l + x,
                                    w = 0 > w ? 0 : w >= d ? d - 1 : w,
                                    w = 4 * (q * d + w),
                                    p = p + c[w],
                                    r = r + c[w + 1],
    ...
    UI.prototype.showActiveView = function () {
        ...
        if (!marmoset.noUserInterface) {
            ...
            void 0 !== marmoset.hostImage && (marmoset.hostURL && (f = document.createElement("a"), f.href = marmoset.hostURL, f.target = "_blank"), e = document.createElement("img"), e.src = marmoset.hostImage, e.style.position = "absolute", e.style.top = "4px", e.style.left = "4px", e.style.opacity = 0.65, e.style["-webkit-transform"] = e.style.transform = "translate(-50%,-50%) scale(0.5,0.5) translate(50%,50%)", marmoset.hostURL ? (e.onmouseover = function () {
                this.style.opacity = 1
            ...
            for (d = b = a = 0; d < this.viewer.scene.meshes.length; ++d) g = this.viewer.scene.meshes[d],
                a += g.indexCount / 3,
                b += g.vertexCount;
    ...
    View.prototype.updateView = function () {
        if (void 0 !== this.limits) {
            ...
            void 0 !== this.limits.orbitRadius && (c = this.limits.orbitRadius.min, b = this.limits.orbitRadius.max, void 0 !== c && (this.radius = Math.max(this.radius, c)), void 0 !== b && (this.radius = Math.min(this.radius, b)));
    ...
    WebViewer.prototype.allocBacking = function () {
        ...
        }), c = this.mainBuffer.valid); !c && a.ext.textureFloat && a.ext.textureFloatLinear && !a.hints.mobile && (this.mainColor.loadArray(null, a.RGBA, a.FLOAT), this.mainBuffer = new Framebuffer(a, {
            color0: this.mainColor,
            depth: this.mainDepth,
            createDepth: !this.mainDepth
        }), c = this.mainBuffer.valid);
        for (; !c;) this.mainColor = new Texture(a, b),
            ...
            b.width /= 2,
            b.height /= 2,
            this.mainDepth && (this.mainDepth.destroy(), this.mainDepth = null);
    ...
    WebViewer.prototype.update = function () {
        ...
        if (0 < this.sleepCounter || this.ui.animating() || a || this.stripData.animationActive) this.stripData.update(),
            this.ui.animate(),
            this.scene.update(),
            this.drawScene(),
            this.requestFrame(this.update.bind(this));
