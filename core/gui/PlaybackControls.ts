...
export default class PlaybackControls{
    ...
    playbackRegion: GUIRegion;
    previousFrameButton:Button;
    nextFrameButton:Button;
    pauseButton:Button;
    visible: boolean;
    backgroundRegion: GUIRegion;
    screenButton:Button;
    guiScreen: any;
    idealSliderWidth: number;
    totalListBoxPixelsX: number;
    minWidth: number;
    compactMode: boolean;
    ui: any;
    bottomOffset: number;
    centerOffset: number;
    maxListPixelsX: number;
    constructor(a:GUIScreen) {
        this.debugString = "";
        this.init = false;
        ...
        if (0 != g) {
            ...
            if (1 < f) {
                ...
                this.cameraList.spawnControl(d, e, 10, 24, true, 8);
            ...
            if (1 < g) {
                ...
                this.animationList.spawnControl(d, e, 10, 24, true, 8);
            ...
            this.speedList.spawnControl(d, e, 44, 24, false, 0);
    ...
    resize(a) {
        ...
        this.speedList.setControl(58, b, 44, 24, false);
        this.cameraList && (this.cameraList.setControl(g, b, 10, 24, true, 8),
            g += this.cameraList.localPixelsX + 14);
        this.animationList && this.animationList.setControl(g, b, 10, 24, true, 8);
    ...
    setupCallbacks() {
        ...
        this.playButton.controlRect.linkedControl.onclick = function () {
            this.ui.viewer.scene.sceneAnimator.pause(false);
            this.playButton.controlRect.showControl(false);
            this.pauseButton.controlRect.showControl(true);
            this.ui.viewer.wake()
        }
            .bind(this);
        this.pauseButton.controlRect.linkedControl.onclick = function () {
            this.ui.viewer.scene.sceneAnimator.pause(true);
            this.playButton.controlRect.showControl(true);
            this.pauseButton.controlRect.showControl(false)
        }
            .bind(this)
    }
}
